...
export default async function Page() {
  ...
  const blogs = await prisma.blog.findMany({ where: { authorId: user.id, status: "REJECTED" }, orderBy: { updatedAt: "desc" }, include: { reviews: { orderBy: { createdAt: "desc" }, take: 1 } } });
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-bold capitalize">rejected</h1>
